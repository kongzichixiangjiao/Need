...
enum GADateFormatType: String {
    case y_m = "yyyy-MM", y_m_d = "yyyy-MM-dd", y_m_d_h_m_s = "yyyy-MM-dd HH:mm:ss", y_m_d_chinese = "yyyy年MM月dd日", y_m_d_h_m_s_chinese = "yyyy年MM月dd日HH:mm:ss", h_m_s = "HH:mm:ss", h_m = "HH:mm", utc = "EEE MMM dd yyyy HH:mm:ss 'GMT'Z '(UTC)'"
}
